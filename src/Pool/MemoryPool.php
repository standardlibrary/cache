...
namespace StandardLibrary\Pool;
 ...
 */
final class MemoryPool implements CacheItemPoolInterface
{
    /**
    ...
    public function getItem($key)
    {
        ...
        throw InvalidArgumentException(sprintf(
            'The key "%s" is not valid in the cache' [, $args...]))
    }
...
final class MemoryCache implements CacheItemInterface
{
    public $cap = 100;
